// 
// shiny-server.js: A reverse proxy server for shiny using sockjs
//
// [browser] <-----sockjs-----> [shiny-server] <----websockets/HTTP----> [shiny apps]
// 
// Call like:
//
// node shiny-server.js
//
...
var shinyConfig = _.extend({
   listenPort: 80,
   listenAddr: '0.0.0.0'   
}, cjson.load("/etc/shiny-server.conf"));
