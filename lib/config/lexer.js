...
var TT = exports.TT = {
  WORD: 'T_WORD',
  OPENBRACE: 'T_OPENBRACE',
  CLOSEBRACE: 'T_CLOSEBRACE',
  TERM: 'T_TERM',
  WS: 'T_WS',
  COMMENT: 'T_COMMENT',
  EOD: 'T_EOD'
...
exports.ConfigLexer = ConfigLexer;
function ConfigLexer(data) {
...
(function() {
  ...
  this.nextToken = function() {
    ...
    var tokenStart = {line: this.$line, col: this.$col};
    ...
    switch (this.$classify(c)) {
      ...
      case C_DQUOTE:
        ...
        break;
      case C_CONTROL:
        throw new Error('Invalid character detected at line ' + this.$line +
            ' column ' + this.$col);
      case C_EOD:
        type = TT.EOD;
        content = '';
