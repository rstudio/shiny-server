...
function createAppWorker(appSpec, endpoint, logStream, workerId, home) {
    return __awaiter(this, void 0, void 0, function () {
        var executable, args, switchUser, logFile, shinyInput, stat, proc_1, dfEnd_1, appWorker_1, stdoutSplit, ex_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    _a.sent();
                    proc_1 = child_process.spawn(executable, args, {
