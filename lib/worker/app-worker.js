...
function createLogFile(pw, appSpec, logFilePath) {
    return __awaiter(this, void 0, void 0, function () {
        var logDir, stat, mode, fileHandle, ex_1, ex_2, writeStream, warned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ex_1 = _a.sent();
                    logger.error("Error attempting to change ownership of log file at ".concat(logFilePath, ": ").concat(ex_1.message));
                    return [3 /*break*/, 5];
                case 5:
                    _a.trys.push([5, 7, , 8]);
                ...
                case 7:
                    ex_2 = _a.sent();
                    logger.error("Error attempting to change permissions on log file at ".concat(logFilePath, ": ").concat(ex_2.message));
                    return [3 /*break*/, 8];
                case 8:
