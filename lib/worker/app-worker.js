 ...
 */
function launchWorker_p(appSpec, endpoint, logFilePath, workerId, loggingInfo) {
  if (!appSpec.runAs)
  ...
  var logInf = _.clone(loggingInfo);
  logInf.File = logFilePath;
