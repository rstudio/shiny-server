...
function createAppWorker(appSpec, endpoint, logStream, workerId, home) {
    return __awaiter(this, void 0, void 0, function () {
        var executable, args, switchUser, logFile, spawnSpec, stat, proc_1, dfEnd_1, appWorker_1, stdoutSplit, ex_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    switch (appSpec.settings.mode) {
                        ...
                        case "rmd":
                            ...
                            break;
                        default:
                            throw new Error("Tried to launch worker process with unknown mode: ".concat(appSpec.settings.mode));
                    }
                    if (switchUser) {
