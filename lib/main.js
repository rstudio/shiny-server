...
MIN_SHINY_VERSION = [0, 6, 0, 99];
MIN_R_VERSION = [2, 14, 1];
...
var metarouter = new LocalConfigRouter(
    new router.RestartRouter(
      router.join(indirectRouter, ping)
    ), eventBus
  );
var localConfigRouter = metarouter;
...
// Set up 
var assets = connect.static(path.resolve(__dirname, '../assets'),
