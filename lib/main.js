...
var SquashRunAsRouter = require('./router/squash-run-as-router');
var AppLogger = require('./worker/app-logger');
...
var schedulerRegistry = new SchedulerRegistry(eventBus, {Key: loggingKey, 
  Port: process.env.SHINY_LOGGING_PORT || 8115});
...
.then(function(){
  if (!appLogger){
    appLogger = new AppLogger(loggingKey, process.env.SHINY_LOGGING_PORT || 8115);
  }
})
.done();
