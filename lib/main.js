...
var metarouter = router.join(
  new router.AutouserRouter('', autouserOptions),
  homepageRedirect,
  //new router.SingleAppRouter('/Users/jcheng/ShinyApps/diamonds', 'jcheng', '/diamonds/', '/Users/jcheng/ShinyApps/log'),
  ping
);
...
var httpServer = http.createServer(shinyProxy.httpListener);
